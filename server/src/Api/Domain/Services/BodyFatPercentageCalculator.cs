...
namespace Api.Domain.Services
{
    public class BodyFatPercentageCalculator
    {
        ...
        private static double CalculateBodyFatPercentageUsingImperialUnits(BodyMeasurement bodyMeasurement)
        {
            ...
            {
                double maleBodyFatPercentage =
                    86.01 * Math.Log10(bodyMeasurement.WaistCircumference - bodyMeasurement.NeckCircumference)
                    - (70.041 * Math.Log10(bodyMeasurement.Height))
                    + 36.76;
            ...
            double femaleBodyFatPercentage =
                163.205
                    * Math.Log10(
                        bodyMeasurement.WaistCircumference + hipCircumference - bodyMeasurement.NeckCircumference
                    )
                - (97.684 * Math.Log10(bodyMeasurement.Height))
                - 78.387;
            ;
