...
namespace Api.Domain.Services
{
    ...
    {
        public static List<BodyMeasurement> Convert(List<BodyMeasurement> bodyMeasurements, MeasurementSystem sourceUnits, MeasurementSystem destinationUnits)
        {
            if (sourceUnits == destinationUnits) return bodyMeasurements;
        ...
        {
            if (sourceUnits == destinationUnits) return bodyMeasurement;
